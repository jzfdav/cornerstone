...
const PROJECT_CODE_HASH =
  'bf28519cc7e8d58009bfad29efac71219be43f135b61ebee09d68176884d099d'

// Login codes = spouse names (SHA-256 hashes)
// User enters their spouse's name to login
const LOGIN_CODE_HASHES: Record<
  string,
  { displayName: string; spouseName: string; role: 'admin' | 'member' }
> = {
...
export async function validateDemoProjectCode(
  code: string,
...
export async function validateDemoLoginCode(
  loginCode: string,
  projectId: string,
